...
class StatusItem {
    ...
    private lazy var menu: NSMenu = {
        ...
        let openSettingsItem = NSMenuItem(
            title: String(format: NSLocalizedString("%@ Settings…", comment: ""), GamingMouse.appName),
        ...
        let quitItem = NSMenuItem(title: String(format: NSLocalizedString("Quit %@", comment: ""), GamingMouse.appName),
